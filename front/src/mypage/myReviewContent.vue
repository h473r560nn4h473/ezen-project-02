	...
	<main>
		...
		<form>
			<div class="wrap" v-for="review in reviewdetail" :key="review.rvw_no">
				...
				<div class="img_wrap">
					<div class="img_frame">
						<img v-if="reviewdetail[0].RVW_IMG" :src="require(`../../../back/uploads/uploadReview/` + `${reviewdetail[0].RVW_IMG}`)" alt="진료후기 사진">
...
export default {
	...
	methods: {
		...
		getReviewImg() {
			if (this.reviewdetail[0].RVW_IMG) {
				return require('../../../back/uploads/uploadReview/' + this.reviewdetail[0].RVW_IMG);
			} else {
				return require('../assets/imgempty.svg');
			}
		},
