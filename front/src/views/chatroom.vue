    ...
    <div class="container">
        <div class="chatroom_container">
            <div class="chatroom_title">
                <span>{{ anotherUser.USER_NM }}님과의 대화</span>
                ...
                <div v-for="(chat, i) in chatList" :key="i">
                    ...
                    <div v-else class="chat_you">
                        <div class="chat_container1">
                            ...
                            :src="anotherUser.user_img ? require(`../../../StarFarmBack/uploads/userImg/${anotherUser.user_no}/${anotherUser.user_img}`) : require('../assets/profile.png')"
                            alt="프로필 이미지" /> -->
                            <p class="chat_name1">{{ anotherUser.USER_NM }}</p>
    ...
    export default {
      ...
      methods: {
        ...
        async getAnotherUser() {
            try {
                const another_user_no = this.$route.params.id;
                const response = await axios.get(`http://localhost:3000/mypage/mypage/${another_user_no}`);
